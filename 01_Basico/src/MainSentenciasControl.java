...
public class MainSentenciasControl {
	...
	public static void main(String[] args) {
		//condicionales
		int numero = 10;
		if (numero >=10 ) {//las llaves son opcionales y agrupan un conjunto de sentencias
		...
		case "MARTES":
			System.out.println("El dia de la senmana es martes");
			break;
		case "MIERCOLES":
		System.out.println("El dia de la senmana es miercoles");
		break;
		default:
			break;
		}
